# kciclabs
This repository provides a React frontend and node backend for building apps that may be used internally or for general prototyping and demoing concepts such as interfacing with the augur microservices infrastructure.
...
npm i
cd client && npm i
# alternatively the Makefile will do this with "sh ./Makefile"
```
Start the dev server with hotloading
```
npm start
```
